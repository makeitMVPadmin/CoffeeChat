// Dummy Data for ConnectionsPage
import RajDevPicture from "../assets/images/RajDev.svg"

const connectionsPageData = [
  {
    id: 1,
    name: "Raj Dev",
    ...
    reviews: ["Best mentor ever!", "Raj is so cool", "Need a mentor? Talk to Raj."],
    // timePreferences: ["9:00am", "2:30pm", "4:00pm"],
  },

];

export default connectionsPageData;